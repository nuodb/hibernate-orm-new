image::https://static.jboss.org/hibernate/images/hibernate_logo_whitebkg_200px.png[,float="left",align="left"]

# Hibernate and NuoDB  &nbsp; &nbsp; image:https://d33wubrfki0l68.cloudfront.net/571989f106f60bced5326825bd63918a55bdf0aa/dd52a/_/img/nuodb-bird-only-green.png[height=40, float="right"]

This is a fork of Hibernate ORM (http://github.com/hibernate/hibernate-orm) to allow testing of NuoDB's Hibernate dialects.
...
For details, pick any of hte following branches 5.6, 6.2 and view its README.  Oher branches are unmodified from the original.
