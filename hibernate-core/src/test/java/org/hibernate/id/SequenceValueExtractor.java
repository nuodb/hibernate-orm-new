...
public class SequenceValueExtractor {
	...
	private long lastValue = 0;   // For NuoDB  15-May-23
	...
	public SequenceValueExtractor(Dialect dialect, String sequenceName) {
		...
		if ( dialect instanceof DerbyDialect ) {
			...
			// NuoDB 15-May-23
			// Get last value generated by sequence - not implemented
			// Run a dummy query
			queryString = "select cast(1 as bigint) from dual";
		}
		else {
